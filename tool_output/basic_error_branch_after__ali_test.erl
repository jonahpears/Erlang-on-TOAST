-module('basic_error_branch_after__ali_test.erl').

-file("basic_error_branch_after__ali_test.erl", 1).
...
main(CoParty, Data) ->
    receive
        {CoParty, act_msgA, Payload_MsgA} ->
            Data1 = save_msg(act_msgA, Payload_MsgA, Data),
            stopping(CoParty, Data1);
        {CoParty, act_msgB, Payload_MsgB} ->
            Data1 = save_msg(act_msgB, Payload_MsgB, Data),
            stopping(CoParty, Data1)
        after 50 -> error(unspecified_error), stopping(CoParty, Data4)
    end.
