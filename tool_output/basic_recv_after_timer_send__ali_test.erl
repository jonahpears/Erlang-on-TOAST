-module('basic_recv_after_timer_send__ali_test.erl').

-file("basic_recv_after_timer_send__ali_test.erl", 1).

-define(MONITORED, false).

-define(MONITOR_SPEC,
        #{init => init_state,
          map => #{state2_recv_after => #{recv => #{before_5s => {stop_state, []}}}, state5_std => #{send => #{after_5s => {stop_state, []}}}}, timeouts => #{},
