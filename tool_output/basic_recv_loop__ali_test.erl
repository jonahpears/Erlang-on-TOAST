-module(basic_recv_loop__ali_test).

-file("basic_recv_loop__ali_test", 1).

-define(MONITORED, false).

-define(MONITOR_SPEC, #{init => state1_std, map => #{state1_std => #{recv => #{msg1 => state1_std}}}, timeouts => #{}, resets => #{}}).
