-module(basic_send_after_timer_recv__ali_test).

-file("basic_send_after_timer_recv__ali_test", 1).

-define(MONITORED, false).

-define(MONITOR_SPEC,
        #{init => state2_send_after, map => #{state2_send_after => #{send => #{before_5s => stop_state}}, state6_std => #{recv => #{after_5s => stop_state}}},
          timeouts => #{state2_send_after => {t, state6_std}}, resets => #{init_state => #{t => 5000}}}).
