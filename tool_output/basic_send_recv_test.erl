...
main(CoParty, Data) ->
    Payload1 = get_payload1(msgA, Data),
    CoParty ! {self(), msgA, Payload1},
    Data1 = save_msg(send, msgA, Payload1, Data),
    temp_show("sent msgA.", [], Data1),
    temp_show("waiting to recv.", [], Data1),
    receive
        {CoParty, msg1 = Label2, Payload2} ->
            Data2 = save_msg(recv, msg1, Payload2, Data1),
            temp_show("recv ~p: ~p.", [Label2, Payload2], Data2),
...
get_payload1(msgA) -> extend_with_functionality_for_obtaining_payload.