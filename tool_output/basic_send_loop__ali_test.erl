-module(basic_send_loop__ali_test).

-file("basic_send_loop__ali_test", 1).

-define(MONITORED, false).

-define(MONITOR_SPEC, #{init => state1_std, map => #{state1_std => #{send => #{msgA => state1_std}}}, timeouts => #{}, resets => #{}}).
