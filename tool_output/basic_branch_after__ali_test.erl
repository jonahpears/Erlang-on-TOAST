-module('basic_branch_after__ali_test.erl').

-file("basic_branch_after__ali_test.erl", 1).
...
main(CoParty, Data) ->
    receive
        ...
        after 5000 -> Data8 = Data1, Payload_Timeout = payload, CoParty ! {self(), timeout, Payload_Timeout}, stopping(CoParty, Data8)
    end.
