...
main(CoParty, Data) ->
    ...
    receive
        {timeout, t, {timer, t}} ->
            ...
            stopping(CoParty, Data1_3)
        after 0 -> Payload_Data = payload, CoParty ! {self(), data, Payload_Data}, loop_state2_if_else(CoParty, Data1_6)
    end.

loop_state2_if_else(CoParty, Data2) ->
    receive
        {timeout, t, {timer, t}} ->
            Payload_Finished = payload,
            CoParty ! {self(), finished, Payload_Finished},
