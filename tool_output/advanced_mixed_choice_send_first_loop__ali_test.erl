-module(advanced_mixed_choice_send_first_loop__ali_test).

-file("advanced_mixed_choice_send_first_loop__ali_test", 1).
...
-define(MONITOR_SPEC,
        #{init => state2_send_after,
          ...
          timeouts => #{state2_send_after => {3000, state9_recv_after}, state3_recv_after => {t1, error_state}, state9_recv_after => {t1, state11_std}},
