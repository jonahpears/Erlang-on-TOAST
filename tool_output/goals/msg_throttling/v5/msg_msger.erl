...
init([], #statem_data{ coparty_id = undefined, states = _States, msgs = _Msgs, timeouts = _Timeouts, state_map = StateMap, queued_actions = _Queue, options = _Options} = StatemData) -> 
